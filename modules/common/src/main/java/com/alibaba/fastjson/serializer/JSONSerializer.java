...
public class JSONSerializer extends SerializeFilterable {
    ...
    public JSONSerializer(SerializeWriter out, SerializeConfig config) {
        ...
        this.out = out; this.config = config;
    }
    ...
    public void setDateFormat(DateFormat dateFormat) {
        ...
        this.dateFormat = dateFormat; if (dateFormatPattern != null) {
    ...
    public void setDateFormat(String dateFormat) {
        ...
        this.dateFormatPattern = dateFormat; if (this.dateFormat != null) {
    ...
    public boolean containsReference(Object value) {
        ...
        SerialContext refContext = references.get(value); if (refContext == null) {
            return false;
        }
    ...
    public void writeReference(Object object) {
        ...
        SerialContext context = this.context; Object current = context.object;

        if (object == current) {
            out.write("{\"$ref\":\"@\"}"); return;
        }
        ...
        SerialContext rootContext = context; for (; ; ) {
        ...
        if (object == rootContext.object) {
            ...
            out.write("{\"$ref\":\""); out.write(references.get(object).toString());
            out.write("\"}");
        }
    }
    ...
    public boolean checkValue(SerializeFilterable filterable) {
        ...
        return (valueFilters != null && valueFilters.size() > 0) //
               ...
               (filterable.contextValueFilters != null &&
                filterable.contextValueFilters.size() > 0) || out.writeNonStringValueAsString;
    }
    ...
    public static void write(Writer out, Object object) {
        ...
        SerializeWriter writer = new SerializeWriter(); try {
            JSONSerializer serializer = new JSONSerializer(writer); serializer.write(object);
            writer.writeTo(out);
    ...
    public static void write(SerializeWriter out, Object object) {
        ...
        JSONSerializer serializer = new JSONSerializer(out); serializer.write(object);
    }
    ...
    public final void write(Object object) {
        ...
        Class<?> clazz = object.getClass(); ObjectSerializer writer = getObjectWriter(clazz);
    ...
    protected final void writeKeyValue(char seperator, String key, Object value) {
        ...
        if (seperator != '\0') {
            out.write(seperator);
        } out.writeFieldName(key); write(value);
    }
    ...
    public final void writeWithFormat(Object object, String format) {
        ...
        if (object instanceof Date) {
            ...
            if (!StringUtils.isEmpty(format)) {
                dateFormat = new SimpleDateFormat(format, locale); dateFormat.setTimeZone(timeZone);
            }
            // end
            String text = dateFormat.format((Date) object); out.writeString(text); return;
        }
        ...
        if (object instanceof byte[]) {
            ...
            if ("gzip".equals(format) || "gzip,base64".equals(format)) {
                GZIPOutputStream gzipOut = null; try {
                    ...
                    } gzipOut.write(bytes); gzipOut.finish();
        ...
        if (object instanceof Collection) {
            Collection collection = (Collection) object; Iterator iterator = collection.iterator();
            out.write('['); for (int i = 0; i < collection.size(); i++) {
                Object item = iterator.next(); if (i != 0) {
                    out.write(',');
